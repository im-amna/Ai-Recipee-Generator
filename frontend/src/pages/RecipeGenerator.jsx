...
const RecipeGenerator = () => {
  ...
  // ✅ FIXED: camelCase → snake_case, servings string bhi parse hoga backend mein
  const handleSaveRecipe = async () => {
    ...
    try {
      await api.post('/recipes', {
        ...
        cuisine_type: generatedRecipe.cuisineType,         // ✅ fix
        difficulty: generatedRecipe.difficulty,
        dietary_tags: generatedRecipe.dietaryTags || [],   // ✅ fix
        prep_time: generatedRecipe.prepTime,               // ✅ fix
        cook_time: generatedRecipe.cookTime,               // ✅ fix
        total_time:
          (generatedRecipe.prepTime || 0) +
          (generatedRecipe.cookTime || 0),                 // ✅ calculated
        servings: generatedRecipe.servings,                // backend parseNum handle karega
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={generating || !preferencesLoaded}
              className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold py-4 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {generating ? (
                <>
